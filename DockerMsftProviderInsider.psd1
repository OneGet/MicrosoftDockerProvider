#
# Module manifest for module 'DockerMsftProviderInsider'
#
...
RootModule = 'DockerMsftProviderInsider.psm1'
...
PrivateData = @{
    "PackageManagementProviders" = 'DockerMsftProviderInsider.psm1'
